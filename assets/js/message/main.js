...
// mobile
    // function barIn() {
    //     $('#details_of_user').animate({ right: 0 }, 'fast');
    //     $('#details_of_user').children().show();
    ...
    // function barOut() {
    //     // I-animate papunta sa right: -100% para itago ang #details_of_user
    //     $('#details_of_user').animate({ right: '-100%' }, 'slow', function() {
    //         // I-hide lahat ng mga anak ng #details_of_user pagkatapos ng animation
    //         $('#details_of_user').children().hide();
    //     });
    ...
    // Click event for the #details_btn
    // $('#details_btn').on('click', function(event) {
    ...
    // // Click event for the entire body
    // $('body').on('click', function(event) {
    //     // Check if the clicked element is not #details_btn and not a child of #details_of_user
